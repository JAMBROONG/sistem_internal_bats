                ...
                <div class="content-wrapper">
                    ...
                    <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu bg-menu-theme flex-grow-0">
                        <div class="container-xxl d-flex h-100">
                            <ul class="menu-inner  justify-content-lg-center">
                                <li class="menu-item" id="dashboard">
                                    <a href="<?= base_url('hospital-app-yearly') ?>" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-home"></i>
                                        <div>Dashboard</div>
                                    </a>
                                </li>
                                <li class="menu-item" id="pasien">
                                    <a href="<?= base_url('hospital-app-yearly-patient') ?>" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-old"></i>
                                        <div>Pasien</div>
                                    </a>
                                </li>
                                <li class="menu-item" id="dokter">
                                    <a href="<?= base_url('hospital-app-yearly-doctor') ?>" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-stethoscope"></i>
                                        <div>Dokter</div>
                                    </a>
                                </li>
                                <li class="menu-item" id="penyakit">
                                    <a href="<?= base_url('hospital-app-yearly-disease') ?>" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-virus"></i>
                                        <div>Penyakit</div>
                                    </a>
                                </li>
                                <li class="menu-item" id="unit">
                                    <a href="<?= base_url('hospital-app-yearly-unit') ?>" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-heart"></i>
                                        <div>Unit</div>
                                    </a>
                                </li>
                                <li class="menu-item" id="produk">
                                    <a href="<?= base_url('hospital-app-yearly-product') ?>" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-package"></i>
                                        <div>Produk</div>
                                    </a>
                                </li>
                                <li class="menu-item" id="obat">
                                    <a href="<?= base_url('hospital-app-yearly-medicine') ?>" class="menu-link">
