...
<?php include 'templates/header.php'; ?><div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="card text-start">
                        <div class="card-body">
                            <h6>Jumlah Pasien Rawat Jalan dan Rawat Inap yang Ditangani oleh Setiap Dokter</h6>
    ...
    <h6 class="mt-4">Pendapatan dari Pelayanan Dokter untuk Rawat Jalan dan Rawat Inap Pertahun</h6>
    <hr>
    ...
    <h6 class="mt-4">Pendapatan dari Pelayanan Dokter untuk Rawat Jalan dan Rawat Inap Pertahun Berdasarkan Jenis Pasien</h6>
    <hr>
    <div class="row mb-4 g-4">
        <div class="col-lg-12">
            <div class="card text-start h-100">
    ...
    <h6 class="mt-4">Pendapatan dari Pelayanan Dokter untuk Rawat Jalan dan Rawat Inap</h6>
    <hr>
    <div class="row mb-4 g-4">
        <div class="col-lg-12">
            <div class="row g-4">
    ...
    <h6 class="mt-4">Pendapatan dari Pelayanan Dokter untuk Rawat Jalan dan Rawat Inap Berdasarkan Jenis Pasien per Dokter</h6>
    <hr>
    <div class="row mb-4 g-4">
        <div class="col-lg-12">
            <div class="card text-start h-100">
