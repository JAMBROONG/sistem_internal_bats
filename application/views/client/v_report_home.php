                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                            ...
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <form action="<?=base_url('Client/report')?>" method="get">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                        <button onclick="window.location='<?=base_url('Client/report?detail='.md5($key['id']))?>'" class="btn btn-sm btn-default d-flex align-items-center">Detail <img src="<?= base_url() ?>assets/icon/detail.png" class="ml-2" width="20px" alt=""> </button>
                                        <?php
                                        }
                                        ?>
                                    </td>
