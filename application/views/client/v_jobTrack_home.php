                                    ...
                                    <td class="text-nowrap">
                                        <?php
                                                    if ($key['service_name'] == 'Monthly Accounting and Tax Compliance') {
                                                        ?>
                                        <button class="btn btn-sm btn-default d-flex align-items-center" data-toggle="modal" data-target="#modelId<?=$no?>">Select Month <img src="<?= base_url() ?>assets/icon/detail.png" class="ml-2" width="20px" alt=""> </button>                                        <div class="modal fade" id="modelId<?=$no?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <form action="<?=base_url('Client/jobTrack')?>" method="get">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                        <button onclick="window.location='<?=base_url('Client/jobTrack?detail='.md5($key['id']))?>'" class="btn btn-sm btn-default d-flex align-items-center">Detail <img src="<?= base_url() ?>assets/icon/detail.png" class="ml-2" width="20px" alt=""> </button>
                                        <?php
                                        }
                                        ?>
                                    </td>
