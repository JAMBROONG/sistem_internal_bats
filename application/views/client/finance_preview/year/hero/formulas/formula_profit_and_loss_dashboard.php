  ...
  "series": [
    {
      ...
      "backgroundColor": "#5b61f1",
    },
    {
      "values": [<?= round($profit_and_loss_dashboard['chartOpex']['ga'])?>],
      "text": "General & Admin",
      "backgroundColor": "#<?=$this->M_table->getByCon("color_theme","name","'color1'")['code'];?>",
    },
  ],
  "legend": {
...
let chartsalesArr = {
  ...
  series: [
    ...
    },
    {
      ...
      backgroundColor: '#<?=$this->M_table->getByCon("color_theme","name","'color1'")['code'];?> #9575CD',
      borderColor: '#673AB7',
      legendMarker: {
        borderColor: '#673AB7',
      },
