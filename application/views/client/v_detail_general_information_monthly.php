...
<body class="hold-transition">
        ...
        <div class="content-wrapper bg-white">
            <section class="content pt-3">
                <div class="container">
                    ...
                    <div class="row p-5">
                        <div class="col-md-6">
                            <h4><?= (!empty($dataOrder['service_name']))?  $dataOrder['service_name'] : 'Select date'; ?></h4>
                        </div>
                        <div class="col-md-6">
                        ...
                        <input type="month" class="form-control datepicker" onchange="changeMonth(this)" value="<?=$date?>" placeholder="mm/yyyy" aria-label="Date" aria-describedby="basic-addon1">
                        </div>

                        </div>
                    </div>
                    <?php
                    if(empty($dataOrder) || empty($dataOrder2)){?>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="error-template text-center">
                                        ...
                                        <a href="<?=base_url('Client/general_information')?>" class="btn btn-sm btn-default align-middle mt-3"><i class="fa fa-arrow-alt-circle-left mr-2"></i> back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header pt-3 text-white" style="background-color: #1A1A1A;">
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="card-text"><?= date('d M Y,h:i A', strtotime($dataOrder['create_date'])); ?></p>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="timeline timeline-inverse">
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            <h3 class="timeline-header border-0 text-primary"><a><strong><?= $dataOrder['service_name'] ?></strong></a>
                                            </h3>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <p class="timeline-header border-0"><?= $dataOrder['description'] ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card shadow-none">
                                            <div class="card-body ">
                                                ...
                                                <input type="text" class=" form-control border-0 " value="<?= $dataOrder['financial_statements'] ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        var monthValue = param.value;
        window.location = '<?=base_url('Client/general_information?detail='.$_GET['detail'].'&date=')?>'+monthValue;
        }
