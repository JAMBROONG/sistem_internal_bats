                ...
                <div class="container-fluid">
                        ...
                        <div class="main-body">
                            <nav aria-label="breadcrumb" class="main-breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Seminar Information</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-4">
                            <a href="<?= base_url('Client/deN/'.$row['id'])?>" class="card mb-2 text-dark">
                        ...
                        <?php
                                    ...
                                    if ($no >=7) {
                                        ?>
                        <div class="col-md-12 text-center p-3 mt-3 bg-light">
                            <a href="<?= base_url('Client/daN')?>" class="text-primary">see more >>></a>
                        </div>
                        <?php
                                        break;
                                    }
                                ...
                                ?>
                            <a href="<?=base_url('Client')?>" class="btn btn-sm btn-danger"><i class="fa fa-arrow-left mr-2"></i> back</a>
                        </div>
            </section>
        </div> 
