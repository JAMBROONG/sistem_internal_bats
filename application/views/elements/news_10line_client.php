<div class="d-flex p-2 card bg-dark mb-3" id="batsnews">
...
<div class="row">
    ...
    function getUrl($x)
    {
        ...
        return $url;
            ...
            website_news_category.category AS category_eng, employee.employee_name, employee.image FROM website_news INNER JOIN website_news_category ON website_news_category.id = website_news.category_id INNER JOIN employee ON employee.id = website_news.employee_id order by website_news.total_seen desc")->result_array();            
            ...
            foreach ($imageAll as $key2) {
                ...
                <div class="col-lg-3 col-6 pb-2"  style="cursor: pointer; hight:100%;" onclick="return window.location.href = '<?=$httpss?>news/<?=getUrl($key['title_eng'])?>'"   data-aos="fade-up"  data-aos-anchor-placement="center-bottom" data-aos-duration="<?= $d ?>">
