    ...
    function getUrl($x)
    {
        ...
        return $url;
            ...
            foreach ($imageAll as $key2) {
                ...
                ?>
                <div class="col-lg-3 col-6 mb-3"  style="cursor: pointer; hight:100%;" onclick="return window.location.href = '<?=$httpss?>news/<?=getUrl($key['title_eng'])?>'">
                    <div class="card h-100">
                        <img class="img-fluid" src="<?=base_url()?>assets/image/website/news_image/<?= (!empty($gambar) ? $gambar : '404.jpg') ?>" style="object-fit: cover; height:150px;">
                        <div class="card-body">
                            <div class="mb-2">
                        ...
                        <div class="card-footer bg d-flex justify-content-between border border-top-0 p-3">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="<?=base_url()?>/assets/upload/images/employee/<?=$key['image']?>" width="25" height="25" alt="">
                                <small style="font-size: 10px;"><?= $key['employee_name'] ?> - BATS Consulting</small>
                            </div>
                            <div class="d-flex align-items-center">
                                <span class="ml-3 text-nowrap" style="font-size: 10px;"><i class="far fa-eye mr-2"></i><?=$key['total_seen']?></span>
                            </div>
                        </div>
                    </div>
                </div>
