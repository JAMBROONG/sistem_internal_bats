                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h5 class="card-title">Order for You Do</h5>
                        </div>
                                ...
                                <thead class="thead-inverse">
                                    ...
                                    foreach ($orderDo as $row) {
                                        ...
                                        <tr>    
                                            ...
                                            <td>
                                                <a href="<?=base_url('Employee/orderReport/'.$row['id'])?>" class="btn btn-sm btn-success"><i class="fa fa-book mr-2"></i> view report</a>
                                            </td>
                                        </tr>
                                        <?php
                                        $no++;
