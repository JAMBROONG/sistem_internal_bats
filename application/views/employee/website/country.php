    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form action="<?=base_url('Employee/addFlag')?>" method="post" enctype="multipart/form-data">
    ...
    <thead class="thead-inverse">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $key['name'] ?></td>
                <td><img style="width: 40px;" src="<?= base_url ()?>assets/image/website/country/<?=$key['image']?>" alt=""></td>
                <td>
                    <a href="<?= base_url('Employee/delCountry/'.$key['id']) ?>" class="btn btn-sm btn-default text-danger alert_notif"><i class="fa fa-trash"></i></a>
                    ...
                    <div id="m_update<?= $key['id'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <form action="<?= base_url('Employee/updateCountry') ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
