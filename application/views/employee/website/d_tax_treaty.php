...
<div class="col-md-3">
    <select name="" class="select2" style="width: 100%;" onchange="window.location.href=  this.options[this.selectedIndex].value">
        <option vvalue="<?= base_url('Employee/websiteMe/tax_treaty/'.md5($country_selected['id']))?>"><?=$country_selected['name']?></option>
        <?php
        $no = 0;
            foreach ($country as $key) {
                ?>
                <option value="<?= base_url('Employee/websiteMe/tax_treaty/'.md5($key['id']))?>"><?=$key['name']?></option>
                <?php
            $no++;
            }
        ?>
                    ...
                    <div class="card-body">
                                    ...
                                    if ($p3b) {
                                        foreach ($p3b as $key) {
                                            if ($key['lang'] == "ind") {
                                                ?>
                                            <form action="<?= base_url('Employee/updateP3B') ?>" method="POST">
                                    ...
                                    if ($no3 ==0){
                                        ?>
                                            ...
                                            <form action="<?= base_url('Employee/addP3B') ?>" method="post">
                                            <input type="hidden" name="country" value="<?=$country_selected['name']?>">
                                            <input type="hidden" name="country_id" value="<?= $country_selected['id'] ?>">
                                            <input type="hidden" name="lang" value="ind">
                                                <div class="form-group row d-flex align-items-center">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
