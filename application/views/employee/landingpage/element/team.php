    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
                <div class="member">
                    <img src="<?=base_url()?>assets/landingpage/assets/img/team/team-1.jpg" alt="">
                    <h4>Walter White</h4>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
                <div class="member">
                    <img src="<?=base_url()?>assets/landingpage/assets/img/team/team-2.jpg" alt="">
                    <h4>Sarah Jhinson</h4>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
                <div class="member">
                    <img src="<?=base_url()?>assets/landingpage/assets/img/team/team-3.jpg" alt="">
