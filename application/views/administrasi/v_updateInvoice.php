                ...
                <div class="container-fluid">
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-5">
                            <div class="card">
                                <div class="card-body">
                                    <form action="<?= base_url('Administrasi/processUpdateInvoice') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <a href="<?= base_url('Administrasi/detailInvoice/'.$order_id)?>" class="btn btn-sm btn-danger">Cancel</a>
