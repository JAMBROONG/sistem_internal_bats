            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url('Administrasi/invoice'); ?>" class="nav-link text-white" style="background-color: #C1272D;">
                          ...
                          foreach ($dataInvoice as $key) {
                              ?>
                                    ...
                                    if ($key['sent_hardfile'] == "no") {
                                        echo'not yet sent';
                                        ?>
                                            <a href="<?=base_url('Administrasi/updateStatusInvoice/'.$key['id'])?>" class="btn btn-sm btn-success ml-2">mark sent</a>
                                            <?php
                                        ...
                                        if ($key['receive_hardfile'] == "yes") {
                                            ...
                                            ?>
                                            <a href="<?=base_url('Administrasi/updateStatusInvoice/'.$key['id'])?>" class="btn btn-sm btn-danger ml-2">mark not sent</a>
                                            <?php
                                        }
                                    }
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-secondary mr-2 btn-disabled"  data-toggle="modal" data-target="#modal-warning"><i class="fa fa-download"></i></a>
                                            <?php
                                            }
                                            if ($key['status'] == "do") {?>
                                            <a href="<?= base_url('Administrasi/viewUpdateInvoice/'.$key['id'])?>" class="btn btn-sm btn-success mr-2"><i class="fa fa-edit"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <a href="<?= base_url('Administrasi/deleteInvoice/'.$key['id'].'/'.$order_id) ?>" class="btn btn-success">Yes delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                              ...
                              ?>
                                    ...
                                    <script>
                                        document.getElementById("click<?=$key['id']?>").onclick = function() {
                                            window.location.href = "<?= base_url('Administrasi/deletePaymentOnly/'.$key['id']).'/'.$order_id?>";
                                        }
                                    </script>
    ...
    <div class="modal fade " id="modal-addData">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Administrasi/processCreateInvoice') ?>" method="post" enctype="multipart/form-data">
