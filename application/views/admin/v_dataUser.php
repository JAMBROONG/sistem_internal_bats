            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <div class="jumbotron bg-info">
                        ...
                        <p class="lead">Ini cuma gambaran gede dari data user, atau banyaknya orang yang bisa akses aplikasi ini berdasarkan rolenya.</p>
                        <hr class="my-4">
                    </div>
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                ...
                                <a href="<?php echo base_url('Admin/dataClient'); ?>" class="small-box-footer">More<i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                ...
                                <a href="<?php echo base_url('Admin/dataEmployee'); ?>" class="small-box-footer">More<i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                ...
                                <a href="<?php echo base_url('Admin/dataAdmin'); ?>" class="small-box-footer">More<i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                ...
                                <a href="<?php echo base_url('Admin/dataAdministrasi'); ?>" class="small-box-footer">More<i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
