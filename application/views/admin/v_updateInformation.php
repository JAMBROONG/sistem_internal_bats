            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url('Admin/dataInformation'); ?>" class="nav-link bg-info">
        ...
        <div class="content-wrapper bg-white">
            <section class="content">
                    ...
                    <div class="main-body">
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('Admin/dataInformation    ')?>">Seminar</a></li>
                ...
                <div class="container-fluid">
                    <div class="card p-3">
                        <form action="<?= site_url('Admin/processUpdateInformation') ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="my-input">Title</label>
                                        <input type="hidden" name="info_id" value="<?= $info['id'] ?>">
                                        <input id="my-input" class="form-control" type="text" name="title" placeholder="enter.." required value="<?= $info['title'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="my-input">Link Group WhatsApp</label>
                                        <input id="my-input" class="form-control" type="text" name="link" placeholder="enter.." required value="<?= $info['link'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputName">Image(landscape)</label>
                                        <input type="file" name="image" class="file">
                                        <div class="input-group">
                                            <input required type="text" class="form-control" disabled placeholder="Upload image" id="file" required value="<?= $info['image'] ?>">
                                            <div class="input-group-append">
                                                <button type="button" id="pilih_gambar" class="browse btn btn-dark">Upload Image</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <img src="<?php echo base_url(); ?>assets/upload/images/news/<?=$info['image']?>" id="preview" class=" border-0 shadow-none rounded img-thumbnail w-50">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="" cols="30" rows="5" class="textarea" placeholder="enter.." required><?= $info['description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
