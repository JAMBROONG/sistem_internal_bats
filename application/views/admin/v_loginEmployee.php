                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-info">
                                        <h3 class="card-title">Select Employee to see Login History</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('Admin/dLoginEmployee/'.$row['id']); ?>" class="btn btn-sm btn-success d-flex align-items-center"><i class="mr-2 fas fa-eye"></i>detail</a>
                                                                    </div>
                                                                </td>
                                                            </tr> <?php
                                              $no++;
