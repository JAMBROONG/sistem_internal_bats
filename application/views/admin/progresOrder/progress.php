<div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
    <div class="card card-default shadow-none">
                ...
                <table id="table_process" class="table table-striped table-valign-middle">
                    ...
                    foreach ($dataProcess as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('Admin/updateProgress/'.$row['id']).'/'.$dataOrder['id'];?>" class="text-primary mr-1">detail</a>
                            </td>
                        </tr> <?php
                            }
                            ?> 
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= site_url('Admin/processCreateProgress/'.$dataOrder['id']) ?>" method="post" class="row">
                    <div class="col-md-6">
