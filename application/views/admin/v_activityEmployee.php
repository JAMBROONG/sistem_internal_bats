                    ...
                    <div class="main-body">
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('Admin/historyEmployee')?>">History Employee</a></li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h3 class="card-title">Select Employee to see <strong>Activity History</strong></h3>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('Admin/dActivityEmployee/'.$row['id']); ?>" class="btn btn-sm btn-success"><i class="mr-2 fas fa-eye"></i>detail</a>
                                                                    </div>
                                                                </td>
                                                            </tr> <?php
                                              $no++;
