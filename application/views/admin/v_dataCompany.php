                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="<?php echo base_url('Admin/createCompany')?>" class="btn btn-sm btn-success"><i class="fa fa-plus mr-1"></i>Add Company</a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('Admin/updateCompany/'.$row['id']); ?>"><i class="btn far fa-edit text-primary"></i></i></a>
                                                                    </div>
                                                                </td>
                                                            </tr> <?php
                                              $no++;
