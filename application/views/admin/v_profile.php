                                ...
                                <div class="col-md-8">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <a href="<?php echo base_url('Admin/updatePasswordA')?>" class="btn btn-sm btn-danger">update password</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="row">
                                                ...
                                                if (empty($resume)) {
                                                    ?>
                                                <form action="<?= site_url('Admin/processCreateResume') ?>" method="post" enctype="multipart/form-data" method="post" class="col-md-12">
                                                            ...
                                                            if ($key['subCategory_id']==$row['id']) {
                                                                if ($key['subCategory_id'] == $bantu) {
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <a href="<?= base_url('Admin/processDeleteSubR/'.$key['id'])?>">
                                                                        ...
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <form action="<?= base_url('Admin/processUpdateSubR')?>" method="post">
    ...
    <div class="modal fade" id="modal-addData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Admin/processCreateSubR')?>" method="post">
                        <label for="" class="mr-2">Select Category</label>
    ...
    <div class="modal fade" id="modal-addCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Admin/processCreateCategory') ?>" method="post">
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <div class="main-body">
                                <form action="<?= site_url('Admin/updateProfile') ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex flex-column align-items-center text-center">
                                                        <img id="preview2" src="<?php echo base_url(); ?>assets/upload/images/admin/<?=$dataUser['image_user']?>" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                                        <div class="mt-3">
                                                        </div>
                                                    </div>
                                                    <hr class="my-4">
    ...
    <div class="modal fade" id="modal-updateImage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= site_url('Admin/processUpdateResume') ?>" method="post" enctype="multipart/form-data" method="post" class="col-md-12">
                    <input type="hidden" value="<?=$resume['resume_id']?>" name="resume_id">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <img id="preview" class=" border-0 shadow-none rounded img-thumbnail w-100">
                            </div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-sm btn-success">save</button>
