                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <a href="<?=base_url('Admin/dataInformation')?>" class="btn btn-sm btn-success"><i class="fa fa-arrow-left mr-2"></i> back</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?php echo base_url('Admin/deleteInformation/'.$info['id']); ?>" class="btn btn-danger">Yes delete</a>
                </div>
            </div>
        </div>
    </div>
