                    ...
                    <div class="main-body">
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('Admin/historyAdmin')?>">History Admin</a></li>
                                ...
                                <div class="row">
                                            ...
                                            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Login date</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Logout date</th>
                                                    </tr>
                                                </thead>
                                                <tbody> <?php
                                    $no = 1;
                                    foreach ($history as $row) {
                                        ?> <tr role="row" class="odd">
                                                        ...
                                                        <td><?= date("l, d F Y H:i:s a", strtotime($row['login'])); ?></td>
                                                        <td><?= date("l, d F Y H:i:s a", strtotime($row['logout']));  ?></td>
                                                    </tr> <?php
                                        $no++;
                                    }
                                    ?> </tbody>
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th rowspan="1" colspan="1">Login date</th>
                                                        <th rowspan="1" colspan="1">Logout date</th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
