                            ...
                            <div class="card">
                                <div class="card-header bg-info">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="<?php echo base_url('Admin/createInformation'); ?>" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> add data </a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        ?>
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex"> 
                                                                        <a href="<?= base_url('Admin/detailInformation/'.$row['id']) ?>" class="btn-sm btn btn-success mr-2">detail</a>
                                                                        <a href="<?= base_url('Admin/updateInformation/'.$row['id']) ?>" class="btn-sm btn btn-primary mr-2">update</a>
                                                                    </div>
                                                                </td>
                                                            </tr> 
                                                        <?php
