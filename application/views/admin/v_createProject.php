                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-info">
                                    <a class="card-title">Create Project</a>
                                </div>
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="settings">
                                            <form class="form-horizontal" action="<?= site_url('Admin/processCreateProject') ?>" method="post">
                                                <div class="form-group row">
                                                    <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="inputName" value="" placeholder="ex: bookkkeeping" name="name" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputName" class="col-sm-2 col-form-label">Description</label>
                                                    <div class="col-sm-10">
                                                        <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="ex: bookkeeping is"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="category_id" class="custom-select form-control-border border-width-2" id="exampleSelectBorderWidth2">
                                                            <option value="0">No Category (default)</option>
                                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="offset-sm-2 col-sm-10">
                                                        <div class="d-flex">
                                                            <button type="submit" class="btn btn-sm btn-success ml-1"><i class="fa fa-save mr-2"></i> save</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
