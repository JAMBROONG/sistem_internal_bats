...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="post">
                                ...
                                <p>
                                    <a href="<?=base_url('Admin/guestTHC')?>" class="link-black text-danger text-sm ml-3">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                <form action="<?=base_url('Admin/updateStatusThc')?>" method="post">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="<?=base_url('Admin/addMeetingThc')?>" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
    ...
    <div id="addFiles" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="<?=base_url('Admin/addReportThc')?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="guest_id" value="<?= $client['id'] ?>">
                        <div class="form-group">
                            <label for="title">Title</label>
