            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <div class="jumbotron bg-info">
                        <p class="lead">Order yang <b>masih</b> kita layanin bersama</p>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <h3 class="card-title"><a href="<?php echo base_url('Admin/addOrder'); ?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> add data </a></h3>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around"> 
                                                                        <a href="<?= base_url('Admin/detailOrder/'.$row['id']) ?>" class="btn-sm btn btn-success d-flex align-items-center mr-1"> <i class="fa fa-book-open mr-2"></i>detail</a>
                                                                        <a href="<?= base_url('Admin/progressOrder/'.$row['id']) ?>" class="btn btn-sm btn-primary d-flex align-items-center"><i class="fa fa-project-diagram mr-2"></i>progress</a>
                                                                    </div>
                                                                </td>
                                                            </tr> 
                                                        <?php
                    ...
                    <div class="jumbotron bg-warning mt-3">
                        <p class="lead">Order yang <b>udah</b> selesai kita layanin bersama</p>
                        <hr class="my-4 border-white">
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="card-title">Data Table Order</h3>
                                        <h3 class="card-title"><strong class="text-success">DONE <i class="fa fa-check-circle"></i></strong></h3>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        ?> 
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around"> 
                                                                        <a href="<?= base_url('Admin/detailOrderDone/'.$row['id']) ?>" class="btn btn-sm btn-success"><i class="fa fa-book-open mr-2"></i> detail</a>
                                                                    </div>
                                                                </td>
                                                            </tr> 
                                                        <?php
