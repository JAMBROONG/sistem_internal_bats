        ...
        <div class="content-wrapper bg-white">
            <section class="content">
                    ...
                    <div class="main-body">
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">History Admin</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="row">
                        <a href="<?= base_url('Admin/loginAdmin')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
                        ...
                        <a href="<?= base_url('Admin/activityAdmin')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
