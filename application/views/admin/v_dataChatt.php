                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview rounded" style="display: none; background-color:#E9ECEF;">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('Admin/dataChatt'); ?>" class="nav-link bg-info">
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-none">
                               ...
                               foreach ($order as $row) {
                                if ($row['user_to_company_id'] != $this->session->userdata('from')) {
                                    continue;
                                    # code...
                                }
                                   ?> <li class="item">
                                            ...
                                            <div class="product-info">
                                                <div class="direct-chat-infos">
                                                    <a href="<?php echo base_url('Admin/selectedChatt/'.$row['id']); ?>" class="product-title"><?=$row['name']?> <span class="direct-chat-timestamp float-right"><?= date('h:m, d F', strtotime($row['create_date']));?></span>
                                                </div>
