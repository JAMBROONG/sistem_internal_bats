                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('Admin/detailFeedbackEmployee/'.$row['id']); ?>"><i class="btn fas fa-eye text-primary"></i></a>
                                                                    </div>
                                                                </td>
                                                            </tr> <?php
                                              $no++;
                                        ...
                                        <div class="row">
                                            <div class="row col-12">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('Admin/detailFeedbackCompany/'.$row['id']); ?>"><i class="btn fas fa-eye text-primary"></i></a>
                                                                    </div>
                                                                </td>
                                                            </tr> <?php
                                              $no++;
