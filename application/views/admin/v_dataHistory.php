            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <a href="<?= base_url('Admin/historyAdmin')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fas fa-fingerprint"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Your Activity</span>
                                    <span class="info-box-number"><?=$admin?>
                                    </span>
                                </div>
                            </div>
                        </a>
                        <a href="<?= base_url('Admin/historyClient')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fas fa-fingerprint"></i></span>
                                <div class="info-box-content">
                        ...
                        <a href="<?= base_url('Admin/historyEmployee')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fas fa-fingerprint"></i></span>
                                <div class="info-box-content">
