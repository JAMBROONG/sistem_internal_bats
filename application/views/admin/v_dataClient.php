                    ...
                    <div class="main-body">
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('Admin/dataUser')?>">User</a></li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="<?php echo base_url('Admin/createClient'); ?>" class="btn btn-sm btn-success"><i class="fa fa-plus mr-1"></i>Add Client</a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('Admin/updateClient/'.$row['id']); ?>"><i class="btn fas fa-edit text-primary"></i></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <a href="<?= base_url('Admin/deleteClient/'.$row['id']); ?>" class="btn btn-danger">Yes delete</a>
                    </div>
                </div>
            </div>
        </div>
