                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="<?php echo base_url('Admin/createRecommendation/'.$dataUser['id']); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus mr-1"></i>Add Services</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="row col-12">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('Admin/deleteRecommendation/'.$row['id'].'/'.$dataUser['id']); ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash mr-2"></i>delete</a>
                                                                    </div>
                                                                </td>
                                                            </tr> 
                                              ...
                                              ?> </tbody>
                                                    ...
                                                    <a href="<?=base_url('Admin/dataRecommendation')?>" class="btn btn-sm btn-danger"><i class="fa fa-arrow-left"></i> back</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
