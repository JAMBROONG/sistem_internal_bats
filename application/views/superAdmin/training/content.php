...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            <h1 class="logo"><a href="<?=base_url('SuperAdmin/preview_training/'.$category['id'])?>" class="text-danger"><i class="fa fa-arrow-left"></i><?=$category['content_training_category']?></a></h1>
