                        ...
                        <div class="card w-100">
                          <div class="card-body p-0 m-0">
                            <div class="icon-box h-100 w-100 shadow-none">
                              ...
                              <h4><a href="<?= base_url('SuperAdmin/content/'. $key['id'])?>"><?= $key['content_title'] ?></a></h4>
                            </div>
                          </div>
                            <a href="<?= base_url('SuperAdmin/content/'. $key['id'].'/'.md5($key['id']))?>" class="btn btn-success btn-sm card-footer bg-warning border-0 text-black">selengkapnya <i class="bx bx-book-reader ml-2"></i></a>
                        </div>
                    </div>
                    <?php
                    $delay = $delay + 150;
