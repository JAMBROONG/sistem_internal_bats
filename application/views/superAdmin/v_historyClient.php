    ...
    <div class="wrapper shadow">
        ...
        <div class="content-wrapper bg-white">
            <section class="content">
                ...
                <div class="container">
                    <div class="row">
                        <a href="<?= base_url('superAdmin/loginClient')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fa fa-sign-in-alt"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Client Login</span>
                                    <span class="info-box-number"><?=$login?>
                                    </span>
                                </div>
                            </div>
                        </a>
                        <a href="<?= base_url('superAdmin/activityClient')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
                ...
                <a href="<?php echo base_url('superAdmin/dataHistory')?>" class="btn btn-sm btn-danger pl-3 pr-3"><i class="mr-2 fa fa-arrow-left"></i> back</a>
                </div>
            </section>
