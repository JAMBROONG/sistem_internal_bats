            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('SuperAdmin/createTypeCompanyClient')?>" method="post">
                        ...
                        <button type="button" data-toggle="modal" data-target="#my-modal" class="btn btn-sm btn-success">
...
?>
                    ...
                    <table class="">
                        ...
                        <tr>
                            ...
                            <td>
                                :
                                <?php
                                $date2 = strtoupper(date('F, Y',strtotime($date ))) ;
                                echo strtoupper($type)  . ' ('. $date2 .')';
                            ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                :
                                <?= strtoupper('manage financial data on ').$date2?></td>
                        </tr>
                    </table>
                    <div>

                        <button onclick="window.location = '<?=base_url('Finance/finance_month?show=y&user_id='.$user_id.'&date='.$date  )?>'" class="btn btn-sm btn-default"><img src="https://cdn.iconscout.com/icon/premium/png-512-thumb/dashboard-126-464794.png?f=avif&w=256" class="mr-2" width="20px" alt=""> dashboard</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <a href="<?=base_url('SuperAdmin/finance_input?user_id='.$user_id.'&&date='.$date   )?>" class="info-box mb-3 bg-info">
            ...
            <div class="col">
                <a href="<?=base_url('SuperAdmin/finance_manage?user_id='.$user_id.'&&date='.$date  )?>" class="info-box mb-3 bg-info">
                    <span class="info-box-icon">
            ...
            <!-- <div class="col"> <a
                href="<?=base_url('SuperAdmin/finance_formula/'.$user_id)?>" class="info-box
                mb-3 bg-info"> <span class="info-box-icon"><i class="fa fa-atom"></i></span>
                <div class="info-box-content"> <span class="info-box-text">Set Formula </span>
                </div> </a> </div> -->
        </div>
      ...
      success: function(data) {
        ...
        $.each(data, function(i, item) {
                ...
                html += '<tr '+bg2+' id="row-'+item.id+'">'+
                            ...
                            '<td scope="row">'+(i+1)+'</td>'+
                            '<td class="dataKomentar">'+item.komentar+'</td>'+
                            '<td class="text-nowrap text-center text-sm dataStatus">'+
                                '<div '+bg+'>'+item.status.toUpperCase()+'</div>'+
                            '</td>'+
