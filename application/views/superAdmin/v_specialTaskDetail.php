        ...
        <section class="content p-2">
            <div class="main-body">
                <nav aria-label="breadcrumb" class="main-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('SuperAdmin/specialtask')?>">Task</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mt-3">
                    <a href="<?= base_url('SuperAdmin/detailSpecialTask?tag='.$key['id']) ?>" type="button" name="" id="btn<?=$key['id']?>" class="btn btn-default btn-lg btn-block"><?= $key['category'] ?></a>
                </div>
                    <?php
                }
                ?>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                ...
                                <?php
                                        if ( $row['status'] == "do") {
                                        echo '
                                        <a href="'.base_url('SuperAdmin/updateStatusTask/'.$row['id']).'" class="btn btn-sm btn-success btn-block mt-1">to done</a>
                                        ';
                                        
                                        } else{
                                            
                                        echo '
                                        <a href="'.base_url('SuperAdmin/updateStatusTask/'.$row['id']).'" class="btn btn-sm btn-danger btn-block mt-1">to do</a>
                                        ';
                                        }
                                        ?>
                            </td>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <a href="<?= base_url('SuperAdmin/deleteTask/'.$row['id']); ?>" class="btn btn-danger">Yes delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal fade" id="modal-update<?=$row['id']?>">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="<?=site_url('SuperAdmin/updateTask')?>">
    ...
    <div class="modal fade" id="modal-addTask" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('SuperAdmin/processCreateTask')?>" method="post">
