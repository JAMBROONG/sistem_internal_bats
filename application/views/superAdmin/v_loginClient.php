                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h3 class="card-title">Select User to see History</h3>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('superAdmin/dLoginClient/'.$row['id']); ?>" class="btn btn-sm btn-success"><i class="mr-2 fas fa-eye"></i>detail</a>
                                                                    </div>
                                                                </td>
                                                            </tr> <?php
                                              $no++;
