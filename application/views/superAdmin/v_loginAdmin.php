    ...
    <div class="wrapper shadow">
        ...
        <div class="content-wrapper bg-white">
            <section class="content">
                    ...
                    <div class="main-body">
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?=base_url('SuperAdmin/historyAdmin')?>">Admin</a></li>
                ...
                <div class="container">
                    <a href="<?php echo base_url('superAdmin/historyAdmin')?>" class="btn btn-sm btn-danger pl-3 pr-3 mb-3"><i class="mr-2 fa fa-arrow-left"></i> back</a>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h3 class="card-title">Select Admin to see History</h3>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-around">
                                                                        <a href="<?php echo base_url('superAdmin/dLoginAdmin/'.$row['id']); ?>" class="btn btn-sm btn-success"><i class="mr-2 fas fa-eye"></i>detail</a>
                                                                    </div>
                                                                </td>
                                                            </tr> <?php
                                              $no++;
