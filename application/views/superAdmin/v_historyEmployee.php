    ...
    <div class="wrapper shadow">
        ...
        <div class="content-wrapper bg-white">
            <section class="content">
                ...
                <div class="container">
                    <div class="row">
                        <a href="<?= base_url('superAdmin/loginEmployee')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
                        ...
                        <a href="<?= base_url('superAdmin/activityEmployee')?>" class="col-12 col-sm-6 col-md-3 link-black">
                            <div class="info-box">
