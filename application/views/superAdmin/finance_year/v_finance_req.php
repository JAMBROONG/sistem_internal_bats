                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="<?=base_url('SuperAdmin/finance_core')?>" id="form1" method="post">
                                <input type="hidden" name="type" value="month">
                                <input type="hidden" name="user_id" value="<?= $user_id ?>">
                                <input type="month" required class="form-control" name="month" id="id_month">
                            </form>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="year" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="<?=base_url('SuperAdmin/finance_core')?>" id="form2" method="post">
                                <input type="hidden" name="type" value="year">
                                <input type="hidden" name="user_id" value="<?= $user_id ?>">
                                <select class="js-example-basic-single" style="width:100%;" name="year"id="years">
                                    <?php
                                    for ($i= 2023; $i > 1900 ; $i--) { ?>
