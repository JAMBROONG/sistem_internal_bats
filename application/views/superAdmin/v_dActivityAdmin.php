                    ...
                    <div class="main-body">
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?=base_url('SuperAdmin/activityAdmin')?>">Activity Admin</a></li>
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header bg-dark">
                            <h3 class="card-title">Activity History <?=$admin['name']?></h3>
                        </div>
                        <div class="card-body">
                            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example1" class="table  table-striped border-0 dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                            <thead>
                                                <tr role="row">
