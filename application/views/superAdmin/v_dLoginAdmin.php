                    ...
                    <div class="main-body">
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?=base_url('SuperAdmin/loginAdmin')?>">Login</a></li>
                                        ...
                                        <div class="col-sm-12">
                                            <table id="example1" class="table border-0 table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                              ...
                                              ?> <tr role="row" class="odd">
                                                        ...
                                                        <td><?= $row['name']?></td>
                                                        <td><?= date("l, j F Y H:m:s a", strtotime($row['login']));?></td>
                                                        <td><?= date("l, j F Y H:m:s a", strtotime($row['logout']));?></td>
                                                    </tr> <?php
                                              $no++;
                                              }
                                              ?> </tbody>
                                            </table>
                                            <a href="<?php echo base_url('superAdmin/loginAdmin')?>" class="btn btn-sm btn-danger pl-3 pr-3"><i class="mr-2 fa fa-arrow-left"></i> back</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
