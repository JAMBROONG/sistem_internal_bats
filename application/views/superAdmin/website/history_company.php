    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form action="<?=base_url('SuperAdmin/addHC')?>" method="post" enctype="multipart/form-data">
...
<table class="table table-striped table-inverse" data-aos="fade-up">
    <thead class="thead-inverse">
        ...
        <tbody>
            <?php
            $no=1;
            foreach ($this->M_table->getAll('history_company') as $key) {
                ?>
            <tr data-aos="fade-up">
                <td scope="row"><?= $no ?></td>
            ...
            <div id="my-modal<?=$no?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form action="<?=base_url('SuperAdmin/updateHC')?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
