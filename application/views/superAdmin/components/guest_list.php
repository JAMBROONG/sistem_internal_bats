                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-around">
                                                    <a href="<?php echo base_url('superAdmin/updateClient/'.$row['id']); ?>" class="btn btn-sm">
                                                        <i class="fas fa-edit text-primary"></i>
                                                    </a>
                                                    <a type="button" data-toggle="modal" data-target="#modal-delete<?=$row['id']?>" class="btn btn-sm">
                                                        <i class=" far fa-trash-alt text-danger"></i>
                                                    </a>
                                                    <a href="<?=base_url('SuperAdmin/guestTHC/'.$row['id'].'/'.md5(122))?>" class="btn btn-success btn-sm">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <a
                                                            href="<?= base_url('superAdmin/deleteClient/'.$row['id']); ?>"
