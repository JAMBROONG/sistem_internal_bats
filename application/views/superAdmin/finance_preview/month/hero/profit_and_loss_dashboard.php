            ...
            <div class="col-lg-6">
                <div class="card rounded-0 h-100">
                    <div class="card-header bg-danger rounded-0">
                        INCOME STATEMENT (Rp.) <b>(<?= date('F, Y' , strtotime($date)) ?>)</b>
                    </div>
                        ...
                        <div class="table-responsive">
                            <dl>
                                ...
                                <dt class=" d-flex justify-content-between bg-light p-2">GROSS PROFIT
                                    <small class="text-bold"><?= v($this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"LABA KOTOR")['value'])?></small>
                                </dt>
                                <dt class=" d-flex justify-content-between bg-light p-2">OPEX
                                    <small class="text-bold"><?= v($this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"BEBAN PENJUALAN")['value'] + $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"BEBAN ADMINISTRASI DAN UMUM")['value'])?></small>
                                </dt>
                                ...
                                <dt class=" d-flex justify-content-between bg-light p-2">OPERATING PROFIT (EBIT)
                                    <small class="text-bold"><?= v($this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"LABA USAHA")['value'])?></small>
                                </dt>
                                <dt class=" d-flex justify-content-between bg-light p-2">OTHER INCOME/(EXPENSES)
                                    <small class="text-bold"><?= v($this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"PENGHASILAN/(BEBAN) LAIN")['value'])?></small>
                                </dt>
                                <dt class=" d-flex justify-content-between bg-light p-2">PROFIT/LOSS BEFORE INCOME TAX
                                    <small class="text-bold"><?= v($this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"LABA/RUGI SEBELUM PAJAK PENGHASILAN")['value'])?></small>
                                </dt>
                                ...
                                <dt class=" d-flex justify-content-between bg-light p-2">NET PROFIT
                                    <small class="text-bold"><?= v($this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"LABA BERSIH")['value'])?></small>
                                </dt>
                            </dl>
                        </div>
                    </div>
          ...
          <div class="col-md-6">
              <div class="card p-0 h-100 rounded-0">
                  <div class="card-header text-center text-md-left  bg-danger rounded-0">
                      ...
                      <small>Month-to-Month | YTD</small>
                  </div>
