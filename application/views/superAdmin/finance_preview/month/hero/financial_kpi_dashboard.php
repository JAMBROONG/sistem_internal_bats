            ...
            <h6 class="d-md-none">FINANCIAL KPI DASHBOARD</h6>
                ...
                <div class="card rounded-0 mt-3 bg-transparent">
                    <div class="card-header  bg-danger rounded-0">
                        Current Working Capital <small>(<?= date('F, Y' , strtotime($date)) ?>)</small>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <table class="table table-responsive-md">
                                    <tbody>
                                        <tr class="bg-dark">
                                            <th>Current Assets <small>(<?= date('F, Y' , strtotime($date)) ?>)</small> (Rp.)</th>
                                            <th class=" text-right text-nowrap"><?= number_format( $cash_management['num_current_aset'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td> Cash and Cash Equivalents</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"KAS DAN SETARA KAS")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Temporary Investment</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"INVESTASI SEMENTARA")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Account Receivable</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"PIUTANG USAHA PIHAK KETIGA")['value'] + $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"PIUTANG USAHA PIHAK YANG MEMPUNYAI HUBUNGAN ISTIMEWA")['value'],0,',','.') ?></th>
                                        </tr>
                                        
                                        <tr class="bg-light">
                                            <td>Other Receivable</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"PIUTANG LAIN-LAIN PIHAK KETIGA")['value'] + $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"PIUTANG LAIN-LAIN PIHAK YANG MEMPUNYAI HUBUNGAN ISTIMEWA")['value'],0,',','.') ?></th>
                                        </tr>
                                        
                                        <tr class="bg-light">
                                            <td>Allowance For Doubtful Accounts	</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"PENYISIHAN PIUTANG RAGU-RAGU")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Inventory</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"PERSEDIAAN")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Advance and Pre-Paid Expenses</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"BEBAN DIBAYAR DI MUKA")['value'] + $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"UANG MUKA PEMBELIAN")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Other Current Assets</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"AKTIVA LANCAR LAINNYA")['value'],0,',','.') ?></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="col-lg-6">
                                <table class="table table-responsive-md">
                                    <tbody>
                                        <tr class="bg-dark">
                                            <th>Current Liabilities <small>(<?= date('F, Y' , strtotime($date)) ?>)</small> (Rp.)</th>
                                            <th class=" text-right text-nowrap"><?= number_format( $cash_management['num_current_liabilities'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Account Payable</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"HUTANG USAHA PIHAK KETIGA")['value'] + $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"HUTANG USAHA PIHAK YANG MEMPUNYAI HUBUNGAN ISTIMEWA")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Interest Payable</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"HUTANG BUNGA")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Tax Payable</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"HUTANG PAJAK")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Dividend Payable</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"HUTANG DIVIDEN")['value'],0,',','.') ?></th>
                                        </tr>
                                        
                                        <tr class="bg-light">
                                            <td>Accrued Expenses</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"BIAYA YANG MASIH HARUS DIBAYAR")['value'],0,',','.') ?></th>
                                        </tr>
                                        
                                        <tr class="bg-light">
                                            <td>Loan Payable</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"HUTANG BANK")['value'],0,',','.') ?></th>
                                        </tr>
                                        
                                        <tr class="bg-light">
                                            <td>Due Date - Long Term Debts</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"BAGIAN HUTANG JANGKA PANJANG YANG JATUH TEMPO DALAM TAHUN BERJALAN")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Customer Advances</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"UANG MUKA PELANGGAN")['value'],0,',','.') ?></th>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>Other Current Liabilities</td>
                                            <th class=" text-right text-nowrap"><?= number_format( $this->M_finance->get_days_sales_outstanding2($user_id,$date.'-02',"KEWAJIBAN LANCAR LAINNYA")['value'],0,',','.') ?></th>
                                        </tr>
                                        ...
                                        <tr class="bg-dark">
                                            <th>Current Ratio </th>
                                            <th class=" text-right text-nowrap"><?= substr(number_format($cash_management['current_ratio'], 10, '.', ''), 0, 3);?></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card rounded-0 h-100">
                            <div class="card-header">
                                Cash Conversion Cycle Mounth to Mounth
                            </div>
                            <div class="card-body">
