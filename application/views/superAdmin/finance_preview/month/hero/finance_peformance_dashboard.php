                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card rounded-0 h-100 shadow-none">
                            <div class="card-header text-center bg-dark rounded-0">RETURN ON ASSETS <br>(<?= date('F, Y' , strtotime($date)) ?>)</div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card rounded-0 h-100 shadow-none">
                            <div class="card-header text-center bg-dark rounded-0">WORKING CAPITAL RATIO <br>(<?= date('F, Y' , strtotime($date)) ?>)</div>
                            <div class="card-body text-center">
                                <?php
                    ...
                    <div class="col-md-6">
                        <div class="card rounded-0 h-100 shadow-none">
                            <div class="card-header text-center bg-dark rounded-0">RETURN ON EQUITY <br>(<?= date('F, Y' , strtotime($date)) ?>)</div>
                            <div class="card-body text-center">
                                <?php
                    ...
                    <div class="col-md-6">
                        <div class="card rounded-0 h-100 shadow-none">
                            <div class="card-header text-center bg-dark rounded-0">DEBT-EQUITY RATIO <br>(<?= date('F, Y' , strtotime($date)) ?>)</div>
                            <div class="card-body text-center">
                                <?php
            ...
            <div class="col-lg-6">
                <div class="card rounded-0 h-100 shadow-none mt-3 mt-lg-0">
                    <div class="card-header text-center bg-dark rounded-0">
                        BALANCE SHEET <br> (<?= date('F, Y' , strtotime($date)) ?>)
                    </div>
