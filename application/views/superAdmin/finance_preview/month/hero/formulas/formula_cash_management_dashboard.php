    ...
    scaleX: {
        ...
        labels: [ <?php
            foreach($cash_management['cash_end_of_month'] as $key) {
                 echo "'".date('M', strtotime($key['spt_date'])).
                " <br> ".date('Y', strtotime($key['spt_date'])).
                "', ";
            }?>
        ],
    ...
    labels: [
        <?php
            foreach($cash_management['inventory'] as $key) {
                 echo "'".date('M', strtotime($key['date'])).
                " <br> ".date('Y', strtotime($key['date'])).
                "', ";
            }?>
    ]
  },
