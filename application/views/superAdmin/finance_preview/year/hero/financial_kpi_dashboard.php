            ...
            <h6 class="d-md-none">FINANCIAL KPI DASHBOARD</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <table class="table table-responsive-md">
                                    <tbody>
                                        <tr class="bg-dark">
                                            <th>Current Liabilities (<?=$date?>) (Rp.)</th>
                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <div class="card rounded-0 h-100">
                            <div class="card-header">
                                Cash Conversion Cycle Year (<?=$date?>)
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-6 d-none">
                        <div class="card rounded-0 h-100">
                            <div class="card-header">
                                Vendor Payment Error Rate - Last 12 Months (<?=$date?>)
                            </div>
                            <div class="card-body">
