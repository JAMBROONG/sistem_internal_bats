...
<div class="card shadow-none rounded-0 mt-3" style="background-color:black">
    <div class="card-header bg-danger rounded-0">WORKING CAPITAL</div>
                    ...
                    <div class="col-sm-6 col-md-12 mb-3">
                        <div class="card rounded-0 h-100">
                            <div class="card-body p-0  d-flex align-items-center justify-content-center" style="background-color:#3E54AC; color: white">
                                <div>
                                    <h5 class="text-center">QUICK RATIO <br> <small>(<?=$date?>)</small></h5><br>
                    ...
                    <div class="col-sm-6 col-md-12 mb-2 mb-lg-0">
                        <div class="card rounded-0 h-100">
                            <div class="card-body p-0 d-flex align-items-center justify-content-center"  style="background-color:#EB455F; color: white">
                                <div>
                                    <h5 class="text-center">CURRENT RATIO <br> <small>(<?=$date?>)</small></h5><br>
                                    <h1 class="text-center">
                                        <!-- <i class="fa fa-check-circle text-success mr-2"></i> -->
                                    <?= substr(number_format($cash_management['current_ratio'], 10, '.', ''), 0, 3);?></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row h-100">
                            <div class="col-md-4 mb-4">
                                <h5 class="text-center">Cash Balance<br><small>(<?=$date?>)</small></h5><br>
...
<div class="card shadow-none rounded-0" style="background-color:black;">
    <div class="card-header   bg-danger rounded-0 text-center text-md-left">CASH CONVERSION (<?=$date?>)</div>
        <div class="card-body p-0">
            <div class="row">
                <div class="col-lg-4 mt-3">
                    <div class="card rounded-0 h-100">
                        <div class="card-body p-0">
                            <h5 class="text-center bg-dark p-3">DAYS SALES OUTSTANDING (<?=$date?>)</h5><br>
                ...
                <div class="col-lg-4 mt-3">
                    <div class="card rounded-0 h-100">
                        <div class="card-body p-0">
                            <h5 class="text-center bg-dark p-3">DAYS INVENTORY OUTSTANDING (<?=$date?>)</h5><br>
                ...
                <div class="col-lg-4 mt-3">
                    <div class="card rounded-0 h-100">
                        <div class="card-body p-0">
                            <h5 class="text-center bg-dark p-3">DAYS PAYABLE OUTSTANDING (<?=$date?>)</h5><br>
            ...
            <div class="row">
                <div class="col-lg-4 mt-3">
                    <div class="card rounded-0 h-100">
                        <div class="card-body p-0">
                            <h5 class="text-center  bg-dark p-3">AR TURNOVER VS. AP TURNOVER (<?=$date?>)</h5><br>
                            <div class="table-responsive">
                                <div id="myChart"></div>
                            </div>
                ...
                <div class="col-lg-4 mt-3">
                    <div class="card rounded-0 h-100">
                        <div class="card-body p-0">
                            <h5 class="text-center  bg-dark p-3">INVENTORY (<?=$date?>)</h5><br>
                ...
                <div class="col-lg-4 mt-3">
                    <div class="card rounded-0 h-100">
                        <div class="card-body p-0">
                            <h5 class="text-center  bg-dark p-3">ACCOUNTS PAYABLE BY PAYMENT TARGET (<?=$date?>)</h5><br>
                            <div class=" table-responsive mb-2">
                                <div id="myChart2"></div>
                            </div>
