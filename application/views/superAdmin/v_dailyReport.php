        ...
        <section class="content p-2">
            ...
            <div class="card shadow-none">
                <div class="card-body table-responsive">
                    <form action="<?= base_url('SuperAdmin/dailyReport'); ?>" method="POST">
                        <div class="row pl-lg-5 pr-lg-5">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="<?=base_url('SuperAdmin/dailyReport')?>" class="btn btn-sm btn-warning"><i class="fa fa-book-reader mr-1"></i> see all</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                ...
                                                <a href="<?= base_url('SuperAdmin/cleanDailyReport') ?>" type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash-alt mr-1"></i>clean</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <a href="<?= base_url('inject-daily-report') ?>" target="blank" class="btn btn-sm btn-dark"><i class="fa fa-cogs mr-2"></i> Inject Daily Report</a> 
                                <a href="<?= base_url('export-daily-report') ?>" target="blank" class="btn btn-sm btn-primary"><i class="fa fa-share mr-2"></i> Export Daily Report</a> 
                            </div>
                        </div>
                    </form>
