                        ...
                        <form action="<?= site_url('SuperAdmin/processCreateReport') ?>" method="post" class="row" enctype="multipart/form-data">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="process_id" style="width: 100%;"> <?php
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <br>
                                                                        <a data-toggle="modal" data-target="#modal-updatePermission<?=$row['id']?>" class="btn btn-sm btn-success">turn on</a>
                                                                        <div class="modal fade " id="modal-updatePermission<?=$row['id']?>">
                                                                            <div class="modal-dialog">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                    ...
                                                                                    <div class="modal-footer justify-content-between">
                                                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                                                        <a href="<?= base_url('SuperAdmin/updateStatusMeetingP/'.$row['id'].'/'.$dataOrder['id']) ?>" class="btn btn-success">Yes update</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <br>
                                                                        <a data-toggle="modal" data-target="#modal-updateFixed<?=$row['id']?>" class="btn btn-sm btn-success">turn on</a>
                                                                        <div class="modal fade " id="modal-updateFixed<?=$row['id']?>">
                                                                            <div class="modal-dialog">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h4 class="modal-title text-danger">Are you sure to update?</h4>
                                                                                    ...
                                                                                    <div class="modal-footer justify-content-between">
                                                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                                                        <a href="<?= base_url('SuperAdmin/updateStatusMeetingF/'.$row['id'].'/'.$dataOrder['id']) ?>" class="btn btn-success">Yes update</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
