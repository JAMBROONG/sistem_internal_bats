...
displaying tang drugs based on the most unsold in<?=$date?>
</p>
<table id="example" class="table table-striped table-bordered text-sm" style="width:100%">
    ...
    <tbody>
        <?php
$no =1;
foreach ($this->M_table->getSellingDrung($user_id, $date,'belum terjual') as $key) {
    ?>
...
<script>
    document.getElementById("btn-mostly_unsold").classList.add("btn-dark");
