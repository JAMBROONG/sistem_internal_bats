...
$(function () {
  ...
  dt_scrollable_table2 = $('.dt-scrollableTable2'),
  dt_scrollable_table3 = $('.dt-scrollableTable3'),
  ...
  if (dt_scrollable_table2.length) {
    var dt_scrollableTable2 = dt_scrollable_table2.DataTable({
      ajax: assetsPath + 'json/table-datatable.json',
      columns: [
        { data: 'Month' },
        { data: 'CO2' },
  ...
  if (dt_scrollable_table3.length) {
    var dt_scrollableTable3 = dt_scrollable_table3.DataTable({
      ajax: assetsPath + 'json/table-datatable.json',
      columns: [
        { data: 'Month' },
        { data: 'CO2' },
