...
(function () {
  ...
  // Revenue Growth Chart
  // --------------------------------------------------------------------
  const revenueGrowthEl2 = document.querySelector('#revenueGrowth2'),
    revenueGrowthConfig2 = {
      chart: {
        height: 162,
        type: 'bar',
        parentHeightOffset: 0,
  ...
  if (typeof revenueGrowthEl2 !== undefined && revenueGrowthEl2 !== null) {
    const revenueGrowth2 = new ApexCharts(revenueGrowthEl2, revenueGrowthConfig2);
    revenueGrowth2.render();
  }
  const revenueGrowthEl3 = document.querySelector('#revenueGrowth3'),
    revenueGrowthConfig3 = {
      chart: {
        height: 162,
        type: 'bar',
        parentHeightOffset: 0,
  ...
  if (typeof revenueGrowthEl3 !== undefined && revenueGrowthEl3 !== null) {
    const revenueGrowth3 = new ApexCharts(revenueGrowthEl3, revenueGrowthConfig3);
    revenueGrowth3.render();
  }
