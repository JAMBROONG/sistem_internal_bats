...
(function () {
  ...
  const shipmentEl = document.querySelector('#shipmentStatisticsChart'),
    shipmentConfig = {
      ...
      colors: [
        chartColors.line.series1, chartColors.line.series2
      ],
      fill: {
        opacity: [1, 1]
      },
  ...
  const deliveryExceptionsChartE1 = document.querySelector('#deliveryExceptionsChart'),
    deliveryExceptionsChartConfig = {
      ...
      labels: [
        'Incorrect address', 'Weather conditions', 'Federal Holidays', 'Damage during transit'
      ],
      series: [
        13, 25, 22, 40
      ],
      colors: [
        chartColors.donut.series1, chartColors.donut.series2, chartColors.donut.series3, chartColors.donut.series4
      ],
      stroke: {
        width: 0
      },
...
$(function () {
  ...
  if (dt_dashboard_table.length) {
    var dt_dashboard = dt_dashboard_table.DataTable({
      ...
      columnDefs: [
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output = '<div class="d-flex justify-content-start align-items-center user-name"><div clas' +
                's="avatar-wrapper"><div class="avatar me-2"><span class="avatar-initial rounded-' +
                'circle bg-label-secondary text-body"><i class="ti ti-truck"></i></span></div></d' +
                'iv><div class="d-flex flex-column"><a class="text-body fw-medium" href="app-logi' +
                'stics-fleet.html">VOL-' + $location + '</a></div></div>';
            return $row_output;
          }
        }, {
          // starting route
          ...
          render: function (data, type, full, meta) {
            ...
            var $progress_output = '<div class="d-flex align-items-center"><div div class="progress w-100" style="he' +
                'ight: 8px;"><div class="progress-bar" role="progressbar" style="width:' + $progress + '%;" aria-valuenow="' + $progress + '" aria-valuemin="0" aria-valuemax="100"></div></div><div class="text-body ms-3">' + $progress + '%</div></div>';
      ...
      dom: '<"table-responsive"t><"row d-flex align-items-center"<"col-sm-12 col-md-6"i><"co' +
          'l-sm-12 col-md-6"p>>',
      displayLength: 5,
      responsive: {
        details: {
